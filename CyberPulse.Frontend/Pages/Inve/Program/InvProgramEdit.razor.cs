...
public partial class InvProgramEdit
{
    private InvProgramForm? invProgramForm;

    private InvProgramDTO? invProgramDTO;
    ...
    {
        var responseHttp = await Repository.GetAsync<InvProgramDTO>($"/api/invprograms/full/{Id}");
        ...
        {
            invProgramDTO = responseHttp.Response;
        }
    }

    private async Task EditAsync()
    {
        var responseHttp = await Repository.PutAsync("api/invprograms/full", invProgramDTO);
