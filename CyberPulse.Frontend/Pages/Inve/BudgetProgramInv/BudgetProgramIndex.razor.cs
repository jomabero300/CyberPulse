...
{
    private List<BudgetProgram>? budgetPrograms { get; set; }
    private MudTable<BudgetProgram> table = new();
    ...
    protected override async Task OnInitializedAsync()
    {
        ...
        //TODO: ESTA GENERANDO ERROR AL CARGAR
    }
    ...
    private async Task<TableData<BudgetProgram>> LoadListAsync(TableState state, CancellationToken cancellationToken)
    {
        ...
        var responseHttp = await repository.GetAsync<List<BudgetProgram>>(url);
    ...
    private async Task DeleteAsync(BudgetProgram entity)
    {
        var parameters = new DialogParameters
        {
