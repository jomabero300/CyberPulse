...
public partial class CourseProgramLotEdit
{
    private CourseProgramLotForm? courseProgramLotForm;

    private CourseProgramLotDTO? courseProgramLotDTO;
    ...
    protected override async Task OnInitializedAsync()
    {
        ...
        {
            courseProgramLotDTO = responseHttp.Response;
        }
    }
    private async Task EditAsync()
    {
        var responseHttp = await Repository.PutAsync("api/courseprogramlots/full", courseProgramLotDTO);
