...
public class LotsController : GenericController<Lot>
{
    ...
    public LotsController(IGenericUnitOfWork<Lot> unitOfWork, ILotUnitOfWork lotunitOfWork, IWebHostEnvironment env) : base(unitOfWork)
    {
